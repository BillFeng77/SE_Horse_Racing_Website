...
export default function Admin() {
  ...
  if (typeof window !== "undefined") {
    if (localStorage.getItem("usertype") !== "admin") {
      //if visitor doesn't have admin permission, reject his access
      Router.push("/");
            ...
            >
              ...
              >
                <Sider className="site-layout-background" width={250}>
                  ...
                  >
                    <Menu.Item key="1">Publish a News</Menu.Item>

                    <Menu.Item key="2">Publish an Announcement</Menu.Item>

                    <Menu.Item key="3">Manage Accounts</Menu.Item>
                  </Menu>
                </Sider>
