        ...
        <div className={styles.main}>
          ...
          <Form form={form} name="UserRegister" onFinish={onFinish}>
            ...
            >
              <Input
                size="large"
                placeholder={intl.formatMessage("Username")}
              />
            </FormItem>
            <Popover
                ...
                visible && (
                  <div style={{ padding: '4px 0' }}>
                    ...
                    <div style={{ marginTop: 10 }}>
                      <span>{intl.formatMessage('Password must be at least 6 characters! Please do not enter easily guessable passwords!')}</span>
                    </div>
                  </div>
                )
              }
            ...
            >
              ...
              >
                <Input
                  size="large"
                  type="password"
                  placeholder={intl.formatMessage('Password')}
                />
              </FormItem>
            </Popover>
            <FormItem
              ...
              rules={[
                {
                  required: true,
                  message: intl.formatMessage('Please confirm your password!'),
                },
                {
            ...
            >
              <Input
                size="large"
                type="password"
                placeholder={intl.formatMessage('Confirm Password')}
              />
            </FormItem>
            ...
            <FormItem>
              <Button
                ...
                htmlType="submit"
              >
                <span>{intl.formatMessage('Register')}</span>
              </Button>
              <Link className={styles.login} to="/user/login">
                <span>{intl.formatMessage('Already have an account')}</span>
              </Link>
            </FormItem>
          </Form>
