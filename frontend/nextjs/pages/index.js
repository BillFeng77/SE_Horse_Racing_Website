  ...
  return (
    <>
      ...
      <Carousel
        ...
        display="flex"
        margin="0 auto"
        style={{ backgroundColor: "#88322F" }}
      >
        <div>
          <h1 style={carouselStyle}>
            <Image src={Horse4} layout="intrinsic" />
          </h1>
        </div>
        <div>
          <h2 style={carouselStyle}>
            <Image src={Horse5} layout="intrinsic" />
          </h2>
        </div>
        <div>
          <h3 style={carouselStyle}>
            <Image src={Horse6} layout="intrinsic" />
          </h3>
        </div>
        <div>
          <h4 style={carouselStyle}>
            <Image src={Horse7} layout="intrinsic" />
          </h4>
        </div>
      </Carousel>
      <Alert
        message={<marquee>{annoucements}</marquee>}
        type="info"
        style={{
          display: "flex",
          margin: "0 auto",
          ...
          <Col>
            <Link href="/news/Is Your Horse at Risk of Colic">
              <Card
                ...
                cover={<Image alt="example" src={Horse1} />}
              >
          ...
          <Col>
            <Link href="/news/Advances in Diagnosing Equine Dental Disease">
              <Card
                ...
                cover={<Image alt="example" src={Horse2} />}
              >
